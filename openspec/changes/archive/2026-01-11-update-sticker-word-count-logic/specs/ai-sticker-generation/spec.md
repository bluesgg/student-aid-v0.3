...
### Requirement: Scanned PDF Rejection (REMOVED)
The system previously rejected scanned PDFs with FILE_IS_SCANNED error. This requirement is removed as scanned PDFs are now supported via page rendering.
